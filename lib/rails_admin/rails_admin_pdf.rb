        ...
        register_instance_option :controller do
          Proc.new do
            ...
            Prawn::Document.new(PDF_OPTIONS) do |pdf|
              ...
              # @object refere-se ao objeto corrente. No menu User, ao clicar no ícone que representa a emissão do pdf, é pego o user corrente (pode ser manager ou salesman, depende da linha que está sendo clicada)
              if @object.name
